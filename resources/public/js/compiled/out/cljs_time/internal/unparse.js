...
var periods__$1 = cljs.core.vec.call(null,(function (){var G__26836 = periods;
if(cljs.core.truth_(short_QMARK_)){
return cljs.core.map.call(null,((function (G__26836){
return (function (p1__26835_SHARP_){
return cljs.core.subs.call(null,p1__26835_SHARP_,(0),(3));
});})(G__26836))
,G__26836);
} else {
return G__26836;
...
cljs_time.internal.unparse.lookup = (function cljs_time$internal$unparse$lookup(p__26845){
var vec__26846 = p__26845;
var t = cljs.core.nth.call(null,vec__26846,(0),null);
var pattern = cljs.core.nth.call(null,vec__26846,(1),null);
if(cljs.core._EQ_.call(null,t,new cljs.core.Keyword(null,"token","token",-1211463215))){
var G__26849 = pattern;
switch (G__26849) {
case "S":
...
switch (G__26859__$1) {
case "millis":
return ((function (G__26859,G__26859__$1){
return (function (p1__26851_SHARP_){
return p1__26851_SHARP_.getMilliseconds();
});
;})(G__26859,G__26859__$1))

break;
case "seconds":
return ((function (G__26859,G__26859__$1){
return (function (p1__26852_SHARP_){
return p1__26852_SHARP_.getSeconds();
});
;})(G__26859,G__26859__$1))
...
return p1__26853_SHARP_.getMinutes();
});
;})(G__26859,G__26859__$1))
...
return p1__26854_SHARP_.getHours();
});
;})(G__26859,G__26859__$1))
...
return p1__26855_SHARP_.getHours();
});
;})(G__26859,G__26859__$1))
...
return p1__26856_SHARP_.getDate();
});
;})(G__26859,G__26859__$1))
...
return p1__26857_SHARP_.getMonth();
});
;})(G__26859,G__26859__$1))
...
return p1__26858_SHARP_.getYear();
});
;})(G__26859,G__26859__$1))
...
cljs_time.internal.unparse.lookup_fn = (function cljs_time$internal$unparse$lookup_fn(syntax_list,i,p__26861){
...
var key = first__26864;
var args = seq__26863__$1;
var G__26865 = key;
...
break;
case "ordinal-suffix":
var vec__26866 = syntax_list.call(null,(i - (1)));
...
var d = value;
var G__26873 = cljs.core.map_indexed.call(null,cljs.core.partial.call(null,cljs_time.internal.unparse.lookup_fn,syn_list),syn_list);
var vec__26874 = G__26873;
...
var unparser = first__26876;
var more = seq__26875__$1;
var s = "";
var d__$1 = d;
...
while(true){
var d__$2 = d__$1;
var vec__26877 = G__26873__$1;
var seq__26878 = cljs.core.seq.call(null,vec__26877);
var first__26879 = cljs.core.first.call(null,seq__26878);
var seq__26878__$1 = cljs.core.next.call(null,seq__26878);
var unparser__$1 = first__26879;
var more__$1 = seq__26878__$1;
var s__$2 = s__$1;
if((unparser__$1 == null)){
return s__$2;
} else {
var vec__26880 = unparser__$1.call(null,s__$2,d__$2);
var s__$3 = cljs.core.nth.call(null,vec__26880,(0),null);
var d__$3 = cljs.core.nth.call(null,vec__26880,(1),null);
var G__26883 = d__$3;
var G__26884 = more__$1;
var G__26885 = s__$3;
d__$1 = G__26883;
G__26873__$1 = G__26884;
s__$1 = G__26885;
continue;
}
break;
...
//# sourceMappingURL=unparse.js.map?rel=1526705063612
