...
var G__23132 = o;
(G__23132[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
var G__23138 = jsprops;
(G__23138["defaultValue"] = value);

(G__23138["onChange"] = ((function (G__23138,v,value,on_change){
return (function (p1__23137_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__23137_SHARP_);
});})(G__23138,v,value,on_change))
);
...
var vec__23141 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__23141,(0),null);
var id = cljs.core.nth.call(null,vec__23141,(1),null);
var class$ = cljs.core.nth.call(null,vec__23141,(2),null);
...
var jsprops = ({"argv": v});
var temp__5461__auto___23145 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5461__auto___23145 == null)){
} else {
var key_23146 = temp__5461__auto___23145;
(jsprops["key"] = key_23146);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__23147 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__23147["name"] = c);
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq23150){
var G__23151 = cljs.core.first.call(null,seq23150);
var seq23150__$1 = cljs.core.next.call(null,seq23150);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__23151,seq23150__$1);
});
...
break;
default:
var G__23157 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__23157;
continue;
...
var n__4376__auto___23159 = a.length;
var i_23160 = (0);
while(true){
if((i_23160 < n__4376__auto___23159)){
(a[i_23160] = reagent.impl.template.as_element.call(null,(a[i_23160])));

var G__23161 = (i_23160 + (1));
i_23160 = G__23161;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__4376__auto___23162 = a.length;
var i_23163 = (0);
while(true){
if((i_23163 < n__4376__auto___23162)){
var val_23164 = (a[i_23163]);
if(((cljs.core.vector_QMARK_.call(null,val_23164)) && ((reagent.impl.template.key_from_vec.call(null,val_23164) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_23163] = reagent.impl.template.as_element.call(null,val_23164));

var G__23165 = (i_23163 + (1));
i_23163 = G__23165;
continue;
} else {
}
...
var ctx = ({});
var vec__23166 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__23166,(0),null);
var derefed = cljs.core.nth.call(null,vec__23166,(1),null);
...
var G__23169 = (cljs.core.count.call(null,argv) - first_child);
switch (G__23169) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__23169){
...
//# sourceMappingURL=template.js.map?rel=1526705059132
