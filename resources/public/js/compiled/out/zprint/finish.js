...
zprint.finish.no_style_map = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"f","f",-1597136552),(function (p1__31524_SHARP_){
if(cljs.core.not_EQ_.call(null,p1__31524_SHARP_,new cljs.core.Keyword(null,"none","none",1333468478))){
return cljs.core.conj.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"reverse","reverse",-888455266)], null),p1__31524_SHARP_);
} else {
 ...
 */
zprint.finish.within_QMARK_ = (function zprint$finish$within_QMARK_(n,p__31525){
var vec__31526 = p__31525;
var low = cljs.core.nth.call(null,vec__31526,(0),null);
var high = cljs.core.nth.call(null,vec__31526,(1),null);
return (((n >= low)) && ((n <= high)));
});
/**
 ...
 */
zprint.finish.ground_color_to_style = (function zprint$finish$ground_color_to_style(p__31529,s,color,element,idx){
...
var style_map = cljs.core.get.call(null,map__31530__$1,new cljs.core.Keyword(null,"style-map","style-map",1488693527));
var focus = cljs.core.get.call(null,map__31530__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var select = cljs.core.get.call(null,map__31530__$1,new cljs.core.Keyword(null,"select","select",1147833503));
 ...
 */
zprint.finish.add_length = (function zprint$finish$add_length(p__31532){
var vec__31533 = p__31532;
var s = cljs.core.nth.call(null,vec__31533,(0),null);
var style = cljs.core.nth.call(null,vec__31533,(1),null);
var start = cljs.core.nth.call(null,vec__31533,(2),null);
 ...
 *   which are in focus.
 */
zprint.finish.gc_vec_to_style_vec = (function zprint$finish$gc_vec_to_style_vec(ctx,idx,p__31536){
var vec__31537 = p__31536;
var s = cljs.core.nth.call(null,vec__31537,(0),null);
var keyword_color = cljs.core.nth.call(null,vec__31537,(1),null);
var element = cljs.core.nth.call(null,vec__31537,(2),null);
...
var vec__31544 = cljs.core.first.call(null,remaining_cvec);
var _ = cljs.core.nth.call(null,vec__31544,(0),null);
var ___$1 = cljs.core.nth.call(null,vec__31544,(1),null);
var element_type = cljs.core.nth.call(null,vec__31544,(2),null);
...
var G__31547 = cljs.core.next.call(null,remaining_cvec);
var G__31548 = new_idx;
var G__31549 = cljs.core.conj.call(null,out,new_idx);
remaining_cvec = G__31547;
idx = G__31548;
out = G__31549;
continue;
}
 ...
 */
zprint.finish.replace_focus_w_cursor = (function zprint$finish$replace_focus_w_cursor(gcw_vec,p__31560,cursor_vec){
var vec__31561 = p__31560;
var focus_start = cljs.core.nth.call(null,vec__31561,(0),null);
var focus_end = cljs.core.nth.call(null,vec__31561,(1),null);
var focus_vec = vec__31561;
...
var vec__31564 = cljs.core.split_at.call(null,focus_start,gcw_vec);
var front = cljs.core.nth.call(null,vec__31564,(0),null);
var back = cljs.core.nth.call(null,vec__31564,(1),null);
 ...
 */
zprint.finish.color_style = (function zprint$finish$color_style(p__31567){
var vec__31568 = p__31567;
var s = cljs.core.nth.call(null,vec__31568,(0),null);
var color = cljs.core.nth.call(null,vec__31568,(1),null);
if((color == null)){
return s;
} else {
...
zprint.finish.cursor_style.cljs$core$IFn$_invoke$arity$2 = (function (p__31574,existing_count){
var vec__31575 = p__31574;
var s = cljs.core.nth.call(null,vec__31575,(0),null);
var cursor = cljs.core.nth.call(null,vec__31575,(1),null);
...
return cljs.core.filterv.call(null,((function (s__$1,len,cursor__$1,vec__31575,s,cursor){
return (function (p1__31571_SHARP_){
return !(cljs.core.empty_QMARK_.call(null,cljs.core.first.call(null,p1__31571_SHARP_)));
});})(s__$1,len,cursor__$1,vec__31575,s,cursor))
...
var vec__31579 = cljs.core.first.call(null,cvec_nl);
var n = cljs.core.nth.call(null,vec__31579,(0),null);
var where = cljs.core.nth.call(null,vec__31579,(1),null);
var cvec_element = vec__31579;
if((cvec_element == null)){
var G__31582 = cljs.core.next.call(null,cvec_nl);
var G__31583 = (idx + (1));
var G__31584 = start;
var G__31585 = out;
cvec_nl = G__31582;
...
var G__31586 = cljs.core.next.call(null,cvec_nl);
var G__31587 = (idx + (1));
var G__31588 = idx;
var G__31589 = cljs.core.conj.call(null,out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null));
cvec_nl = G__31586;
idx = G__31587;
start = G__31588;
out = G__31589;
...
var G__31590 = cljs.core.next.call(null,cvec_nl);
var G__31591 = (idx + (1));
var G__31592 = (idx + (1));
var G__31593 = cljs.core.conj.call(null,out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null));
cvec_nl = G__31590;
idx = G__31591;
start = G__31592;
out = G__31593;
...
var G__31594 = cljs.core.next.call(null,cvec_nl);
var G__31595 = (idx + (1));
var G__31596 = idx;
var G__31597 = cljs.core.apply.call(null,cljs.core.conj,cljs.core.conj.call(null,out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null)),cljs.core.repeat.call(null,n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [idx,idx], null)));
cvec_nl = G__31594;
idx = G__31595;
start = G__31596;
out = G__31597;
...
var G__31598 = cljs.core.next.call(null,cvec_nl);
var G__31599 = (idx + (1));
var G__31600 = start;
var G__31601 = cljs.core.apply.call(null,cljs.core.conj,out,cljs.core.repeat.call(null,n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null)));
cvec_nl = G__31598;
idx = G__31599;
start = G__31600;
out = G__31601;
...
return cljs.core.reduce.call(null,(function (p1__31603_SHARP_,p2__31602_SHARP_){
if(cljs.core.truth_(zprint.finish.within_QMARK_.call(null,idx,p2__31602_SHARP_))){
return cljs.core.reduced.call(null,p1__31603_SHARP_);
} else {
return (p1__31603_SHARP_ + (1));
}
}),(0),lines);
});
/**
 ...
 */
zprint.finish.surround_focus = (function zprint$finish$surround_focus(lines_to_cvec,p__31604,p__31605){
var vec__31606 = p__31604;
var focus_begin = cljs.core.nth.call(null,vec__31606,(0),null);
var focus_end = cljs.core.nth.call(null,vec__31606,(1),null);
var vec__31609 = p__31605;
var before = cljs.core.nth.call(null,vec__31609,(0),null);
var after = cljs.core.nth.call(null,vec__31609,(1),null);
 ...
 */
zprint.finish.handle_lines = (function zprint$finish$handle_lines(p__31613,cvec,focus_vec){
...
var map__31615 = cljs.core.get.call(null,map__31614__$1,new cljs.core.Keyword(null,"output","output",-1105869043));
...
var focus = cljs.core.get.call(null,map__31615__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var lines = cljs.core.get.call(null,map__31615__$1,new cljs.core.Keyword(null,"lines","lines",-700165781));
var paths = cljs.core.get.call(null,map__31615__$1,new cljs.core.Keyword(null,"paths","paths",-1807389588));
...
var path_vecs__$1 = cljs.core.map.call(null,((function (lines_to_cvec,surround,cvec_ranges,cvec_ranges__$1,path_vecs,map__31614,map__31614__$1,options,map__31615,map__31615__$1,focus,lines,paths){
return (function (p1__31612_SHARP_){
return zprint.finish.surround_focus.call(null,lines_to_cvec,p1__31612_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0)], null));
});})(lines_to_cvec,surround,cvec_ranges,cvec_ranges__$1,path_vecs,map__31614,map__31614__$1,options,map__31615,map__31615__$1,focus,lines,paths))
,path_vecs);
...
//# sourceMappingURL=finish.js.map?rel=1526705511218
