...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var pred__32954 = cljs.core.instance_QMARK_;
var expr__32955 = reactive_val;
if(cljs.core.truth_(pred__32954.call(null,mranderson047.reagent.v0v7v0.reagent.ratom.RAtom,expr__32955))){
return "ra";
} else {
if(cljs.core.truth_(pred__32954.call(null,mranderson047.reagent.v0v7v0.reagent.ratom.RCursor,expr__32955))){
return "rc";
} else {
if(cljs.core.truth_(pred__32954.call(null,mranderson047.reagent.v0v7v0.reagent.ratom.Reaction,expr__32955))){
return "rx";
} else {
if(cljs.core.truth_(pred__32954.call(null,mranderson047.reagent.v0v7v0.reagent.ratom.Track,expr__32955))){
return "tr";
} else {
return "other";
}
...
//# sourceMappingURL=interop.js.map?rel=1526705513566
