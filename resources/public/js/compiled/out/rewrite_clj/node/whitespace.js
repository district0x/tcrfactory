...
rewrite_clj.node.whitespace.WhitespaceNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4174__auto__,k30967,else__4175__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.call(null,self__.__extmap,k30967,else__4175__auto__);
...
rewrite_clj.node.whitespace.WhitespaceNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__30966){
var self__ = this;
var G__30966__$1 = this;
return (new cljs.core.RecordIter((0),G__30966__$1,1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"whitespace","whitespace",-1340035483)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator.call(null,self__.__extmap):cljs.core.nil_iter.call(null))));
});
...
rewrite_clj.node.whitespace.WhitespaceNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this30968,other30969){
var self__ = this;
var this30968__$1 = this;
return ((!((other30969 == null))) && ((this30968__$1.constructor === other30969.constructor)) && (cljs.core._EQ_.call(null,this30968__$1.whitespace,other30969.whitespace)) && (cljs.core._EQ_.call(null,this30968__$1.__extmap,other30969.__extmap)));
});
...
rewrite_clj.node.whitespace.WhitespaceNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4179__auto__,k__4180__auto__,G__30966){
var self__ = this;
var this__4179__auto____$1 = this;
var pred__30972 = cljs.core.keyword_identical_QMARK_;
var expr__30973 = k__4180__auto__;
if(cljs.core.truth_(pred__30972.call(null,new cljs.core.Keyword(null,"whitespace","whitespace",-1340035483),expr__30973))){
return (new rewrite_clj.node.whitespace.WhitespaceNode(G__30966,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.whitespace.WhitespaceNode(self__.whitespace,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__4180__auto__,G__30966),null));
}
});
...
rewrite_clj.node.whitespace.WhitespaceNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4171__auto__,G__30966){
var self__ = this;
var this__4171__auto____$1 = this;
return (new rewrite_clj.node.whitespace.WhitespaceNode(self__.whitespace,G__30966,self__.__extmap,self__.__hash));
});
 ...
 */
rewrite_clj.node.whitespace.map__GT_WhitespaceNode = (function rewrite_clj$node$whitespace$map__GT_WhitespaceNode(G__30970){
return (new rewrite_clj.node.whitespace.WhitespaceNode(new cljs.core.Keyword(null,"whitespace","whitespace",-1340035483).cljs$core$IFn$_invoke$arity$1(G__30970),null,cljs.core.not_empty.call(null,cljs.core.dissoc.call(null,G__30970,new cljs.core.Keyword(null,"whitespace","whitespace",-1340035483))),null));
});
...
rewrite_clj.node.whitespace.NewlineNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4174__auto__,k30977,else__4175__auto__){
var self__ = this;
var this__4174__auto____$1 = this;
var G__30981 = k30977;
...
break;
default:
return cljs.core.get.call(null,self__.__extmap,k30977,else__4175__auto__);
...
rewrite_clj.node.whitespace.NewlineNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__30976){
var self__ = this;
var G__30976__$1 = this;
return (new cljs.core.RecordIter((0),G__30976__$1,1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"newlines","newlines",-1185451518)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator.call(null,self__.__extmap):cljs.core.nil_iter.call(null))));
});
...
rewrite_clj.node.whitespace.NewlineNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this30978,other30979){
var self__ = this;
var this30978__$1 = this;
return ((!((other30979 == null))) && ((this30978__$1.constructor === other30979.constructor)) && (cljs.core._EQ_.call(null,this30978__$1.newlines,other30979.newlines)) && (cljs.core._EQ_.call(null,this30978__$1.__extmap,other30979.__extmap)));
});
...
rewrite_clj.node.whitespace.NewlineNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4179__auto__,k__4180__auto__,G__30976){
var self__ = this;
var this__4179__auto____$1 = this;
var pred__30982 = cljs.core.keyword_identical_QMARK_;
var expr__30983 = k__4180__auto__;
if(cljs.core.truth_(pred__30982.call(null,new cljs.core.Keyword(null,"newlines","newlines",-1185451518),expr__30983))){
return (new rewrite_clj.node.whitespace.NewlineNode(G__30976,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.whitespace.NewlineNode(self__.newlines,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__4180__auto__,G__30976),null));
}
});
...
rewrite_clj.node.whitespace.NewlineNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4171__auto__,G__30976){
var self__ = this;
var this__4171__auto____$1 = this;
return (new rewrite_clj.node.whitespace.NewlineNode(self__.newlines,G__30976,self__.__extmap,self__.__hash));
});
 ...
 */
rewrite_clj.node.whitespace.map__GT_NewlineNode = (function rewrite_clj$node$whitespace$map__GT_NewlineNode(G__30980){
return (new rewrite_clj.node.whitespace.NewlineNode(new cljs.core.Keyword(null,"newlines","newlines",-1185451518).cljs$core$IFn$_invoke$arity$1(G__30980),null,cljs.core.not_empty.call(null,cljs.core.dissoc.call(null,G__30980,new cljs.core.Keyword(null,"newlines","newlines",-1185451518))),null));
});
...
var comma_30986 = rewrite_clj.node.whitespace.whitespace_node.call(null,", ");
/**
 * Interleave the given seq of nodes with `", "` nodes.
 */
rewrite_clj.node.whitespace.comma_separated = ((function (comma_30986){
return (function rewrite_clj$node$whitespace$comma_separated(nodes){
return cljs.core.butlast.call(null,cljs.core.interleave.call(null,nodes,cljs.core.repeat.call(null,comma_30986)));
});})(comma_30986))
;
var nl_30987 = rewrite_clj.node.whitespace.newline_node.call(null,"\n");
/**
 * Interleave the given seq of nodes with newline nodes.
 */
rewrite_clj.node.whitespace.line_separated = ((function (nl_30987){
return (function rewrite_clj$node$whitespace$line_separated(nodes){
return cljs.core.butlast.call(null,cljs.core.interleave.call(null,nodes,cljs.core.repeat.call(null,nl_30987)));
});})(nl_30987))
;
var space_30988 = rewrite_clj.node.whitespace.whitespace_node.call(null," ");
/**
 * Interleave the given seq of nodes with `" "` nodes.
 */
rewrite_clj.node.whitespace.space_separated = ((function (space_30988){
return (function rewrite_clj$node$whitespace$space_separated(nodes){
return cljs.core.butlast.call(null,cljs.core.interleave.call(null,nodes,cljs.core.repeat.call(null,space_30988)));
});})(space_30988))
;
/**
...
//# sourceMappingURL=whitespace.js.map?rel=1526705509434
