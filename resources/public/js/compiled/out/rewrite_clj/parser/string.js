...
if((c === "\n")){
var G__31177 = escape_QMARK_;
var G__31178 = rewrite_clj.parser.string.flush_into.call(null,lines,buf);
escape_QMARK_ = G__31177;
lines = G__31178;
continue;
} else {
buf.append(c);

var G__31179 = ((!(escape_QMARK_)) && ((c === "\\")));
var G__31180 = lines;
escape_QMARK_ = G__31179;
lines = G__31180;
continue;
...
//# sourceMappingURL=string.js.map?rel=1526705510089
