...
return rewrite_clj.reader.read_repeatedly.call(null,reader,(function (p1__31183_SHARP_){
var _STAR_delimiter_STAR_31184 = rewrite_clj.parser.core._STAR_delimiter_STAR_;
rewrite_clj.parser.core._STAR_delimiter_STAR_ = delimiter;

try{return rewrite_clj.parser.core.parse_next.call(null,p1__31183_SHARP_);
}finally {rewrite_clj.parser.core._STAR_delimiter_STAR_ = _STAR_delimiter_STAR_31184;
}}));
});
rewrite_clj.parser.core.parse_printables = (function rewrite_clj$parser$core$parse_printables(var_args){
var args__4502__auto__ = [];
var len__4499__auto___31193 = arguments.length;
var i__4500__auto___31194 = (0);
while(true){
if((i__4500__auto___31194 < len__4499__auto___31193)){
args__4502__auto__.push((arguments[i__4500__auto___31194]));

var G__31195 = (i__4500__auto___31194 + (1));
i__4500__auto___31194 = G__31195;
continue;
} else {
}
break;
...
rewrite_clj.parser.core.parse_printables.cljs$core$IFn$_invoke$arity$variadic = (function (reader,node_tag,n,p__31189){
var vec__31190 = p__31189;
var ignore_QMARK_ = cljs.core.nth.call(null,vec__31190,(0),null);
...
/** @this {Function} */
rewrite_clj.parser.core.parse_printables.cljs$lang$applyTo = (function (seq31185){
...
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__31186,G__31187,G__31188,seq31185__$3);
});
...
return cljs.core.cons.call(null,(function (){var G__31196 = rewrite_clj.reader.peek.call(null,reader);
switch (G__31196) {
case "(":
...
var G__31198 = cljs.tools.reader.reader_types.peek_char.call(null,reader);
if(cljs.core._EQ_.call(null,null,G__31198)){
return rewrite_clj.reader.throw_reader.call(null,reader,"Unexpected EOF.");
} else {
if(cljs.core._EQ_.call(null,"{",G__31198)){
...
if(cljs.core._EQ_.call(null,"_",G__31198)){
...
//# sourceMappingURL=core.js.map?rel=1526705510131
