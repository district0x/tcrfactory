...
var line = cljs.core.get.call(null,map__36132__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__36132__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e36131){var _e = e36131;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5455__auto___36134 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5455__auto___36134)){
var seen_errors_36135 = temp__5455__auto___36134;
if(cljs.core.truth_(seen_errors_36135.has(self))){
} else {
seen_errors_36135.add(self);

var temp__5457__auto___36136 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5457__auto___36136)){
var sense_36137 = temp__5457__auto___36136;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_36137)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1526705517610
