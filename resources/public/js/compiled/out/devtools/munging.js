...
var o30246 = temp__5455__auto__;
var temp__5455__auto____$1 = (o30246["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o30247 = temp__5455__auto____$1;
return (o30247["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__29356__auto__ = f;
return (o__29356__auto__["toString"]).call(o__29356__auto__);
} else {
return "";
}
}catch (e30248){var _ = e30248;
return "";
}});
...
try{var o__29356__auto___30250 = t;
(o__29356__auto___30250["cljs$lang$ctorPrWriter"]).call(o__29356__auto___30250,t,writer);
}catch (e30249){var __30251 = e30249;
}
...
var char_code = (function (){var o__29356__auto__ = (new String(char$));
return (o__29356__auto__["charCodeAt"]).call(o__29356__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__29356__auto__ = String;
return (o__29356__auto__["fromCharCode"]).call(o__29356__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__30252 = num_code;
switch (G__30252) {
case (1):
return (185);
...
var o__29356__auto__ = String;
return (o__29356__auto__["fromCharCode"]).call(o__29356__auto__,superscript_code);
});
/**
...
}catch (e30254){var _e__29363__auto__ = e30254;
return false;
}})())){
...
var vec__30255 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__30255,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o30258 = temp__5455__auto__;
var temp__5455__auto____$1 = (o30258["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o30259 = temp__5455__auto____$1;
return (o30259["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__30262){
var vec__30263 = p__30262;
var ns_detector = cljs.core.nth.call(null,vec__30263,(0),null);
...
var G__30269 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__30270 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__30269;
remaining_tokens = G__30270;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq30260){
var G__30261 = cljs.core.first.call(null,seq30260);
var seq30260__$1 = cljs.core.next.call(null,seq30260);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__30261,seq30260__$1);
});
...
var vec__30274 = cljs.core.split_with.call(null,(function (p1__30273_SHARP_){
return cljs.core.not_EQ_.call(null,p1__30273_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__30274,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__30274,(1),null);
...
var vec__30277 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__30277,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__30277,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__30280 = cljs.core.rest.call(null,remaining_tokens);
var G__30281 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__30280;
name_tokens = G__30281;
continue;
} else {
...
var vec__30284 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__30284,(0),null);
var arity = cljs.core.nth.call(null,vec__30284,(1),null);
var vec__30287 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__30287,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__30287,(1),null);
var vec__30290 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__30290,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__30290,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__30290,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__30290,(3),null);
...
var vec__30296 = result;
var munged_ns = cljs.core.nth.call(null,vec__30296,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__30296,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__30296,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__30296,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__30296,(4),null);
var arity = cljs.core.nth.call(null,vec__30296,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__30300 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__30300,(0),null);
var args = cljs.core.nth.call(null,vec__30300,(1),null);
var vec__30303 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__30303,(0),null);
var name = cljs.core.nth.call(null,vec__30303,(1),null);
...
var G__30306 = (arity + (1));
var G__30307 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__30308){
var vec__30309 = p__30308;
var arity = cljs.core.nth.call(null,vec__30309,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__30309,(1),null);
...
return cljs.core.get.call(null,arities,p1__30312_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__30313_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__30316){
var vec__30317 = p__30316;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__30317,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq30314){
var G__30315 = cljs.core.first.call(null,seq30314);
var seq30314__$1 = cljs.core.next.call(null,seq30314);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__30315,seq30314__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__30325__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__30325__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__30325__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__30325__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__30326 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__30326,(0),null);
var fn_name = cljs.core.nth.call(null,vec__30326,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__30326,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__30326,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__30326,(4),null);
var arity = cljs.core.nth.call(null,vec__30326,(5),null);
...
var o__29356__auto__ = f;
return (o__29356__auto__["getBasis"]).call(o__29356__auto__);
});
/**
...
}catch (e30330){var _e__29363__auto__ = e30330;
...
var G__30331 = (obj[cljs.core.first.call(null,path)]);
var G__30332 = cljs.core.rest.call(null,path);
obj = G__30331;
path = G__30332;
continue;
} else {
...
return (function (accum,p__30333){
var vec__30334 = p__30333;
var bit = cljs.core.nth.call(null,vec__30334,(0),null);
var protocol = cljs.core.nth.call(null,vec__30334,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__30337){
var vec__30338 = p__30337;
var ns = cljs.core.nth.call(null,vec__30338,(0),null);
var name = cljs.core.nth.call(null,vec__30338,(1),null);
var selector = cljs.core.nth.call(null,vec__30338,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__30343,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__30343,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__30343,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__30341_SHARP_){
return (obj[cljs.core.first.call(null,p1__30341_SHARP_)]);
});})(name,sorted_matches,vec__30343,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1526705508234
