...
/** @this {Function} */
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq30374){
...
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__30375,G__30376,seq30374__$2);
});
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__30380_SHARP_){
return !((cljs.core.meta.call(null,p1__30380_SHARP_) == null));
})))){
...
var markup_db = cljs.core.get.call(null,map__30381__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e30385){var _e__29363__auto__ = e30385;
return false;
}})();
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
...
}catch (e30387){var _e__29363__auto__ = e30387;
return false;
}}
})())){
...
var _STAR_current_state_STAR_30389 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__30390 = opts;
...
var markup_db = cljs.core.get.call(null,map__30390__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_30389;
}});
...
;
var temp__5455__auto___30394 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5455__auto___30394)){
var managed_print_level_30395 = temp__5455__auto___30394;
var _STAR_print_level_STAR_30393_30396 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_30395;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_30393_30396,managed_print_level_30395,temp__5455__auto___30394,writer,opts,job_fn){
return (function (p1__30392_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__30392_SHARP_,null);
});})(_STAR_print_level_STAR_30393_30396,managed_print_level_30395,temp__5455__auto___30394,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_30393_30396;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1526705508412
