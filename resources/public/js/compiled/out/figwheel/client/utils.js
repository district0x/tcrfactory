...
return (new CustomEvent(event_name,(function (){var obj34545 = {"detail":data};
return obj34545;
})()));
} else {
...
var f = (function (){var pred__34552 = cljs.core._EQ_;
var expr__34553 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__34552.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__34553))){
return ((function (pred__34552,expr__34553){
return (function (p1__34546_SHARP_){
return console.warn(p1__34546_SHARP_);
});
;})(pred__34552,expr__34553))
} else {
if(cljs.core.truth_(pred__34552.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__34553))){
return ((function (pred__34552,expr__34553){
return (function (p1__34547_SHARP_){
return console.debug(p1__34547_SHARP_);
});
;})(pred__34552,expr__34553))
} else {
if(cljs.core.truth_(pred__34552.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__34553))){
return ((function (pred__34552,expr__34553){
return (function (p1__34548_SHARP_){
return console.error(p1__34548_SHARP_);
});
;})(pred__34552,expr__34553))
} else {
return ((function (pred__34552,expr__34553){
return (function (p1__34549_SHARP_){
return console.log(p1__34549_SHARP_);
});
;})(pred__34552,expr__34553))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__34556){
...
var eval_fn = cljs.core.get.call(null,map__34557__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__34559_SHARP_);
});})(new_def))
);
...
return (function (p__34560){
var vec__34561 = p__34560;
var ky = cljs.core.nth.call(null,vec__34561,(0),null);
var v = cljs.core.nth.call(null,vec__34561,(1),null);
...
}catch (e34566){if((e34566 instanceof Error)){
var e = e34566;
return not_found;
} else {
throw e34566;
...
//# sourceMappingURL=utils.js.map?rel=1526705069273
