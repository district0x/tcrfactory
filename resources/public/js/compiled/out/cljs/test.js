...
var G__22729 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__22729,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__22729;
}
});
...
/** @this {Function} */
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq22731){
...
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__22732,G__22733,seq22731__$2);
});
...
var file = cljs.core.get.call(null,map__22738__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__22738__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__22738__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__22738,map__22738__$1,file,line,column){
return (function (p1__22737_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__22737_SHARP_));
});})(map__22738,map__22738__$1,file,line,column))
...
var temp__5457__auto___22740 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___22740)){
var message_22741 = temp__5457__auto___22740;
cljs.core.println.call(null,message_22741);
} else {
}
...
var temp__5457__auto___22742 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___22742)){
var message_22743 = temp__5457__auto___22742;
cljs.core.println.call(null,message_22743);
} else {
}
...
var output_dir__$1 = (function (){var G__22744 = output_dir;
if(!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/"))){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__22744),"/"].join('');
} else {
return G__22744;
}
})();
...
var G__22746 = exception.stack;
var G__22746__$1 = (((G__22746 == null))?null:clojure.string.split_lines.call(null,G__22746));
var G__22746__$2 = (((G__22746__$1 == null))?null:cljs.core.get.call(null,G__22746__$1,depth));
if((G__22746__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__22746__$2);
}
} else {
...
var vec__22747 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__22747,(0),null);
var column = cljs.core.nth.call(null,vec__22747,(1),null);
var vec__22750 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__22750,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__22750,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__22750,(2),null);
...
var m__$1 = (function (){var G__22753 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__22757 = (function (){var G__22756 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__22756);
} else {
return G__22756;
}
})();
...
return cljs.core.vary_meta.call(null,G__22758,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__22762 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__22762,(0),null);
var types = vec__22762;
...
return cljs.core.map.call(null,(function (p__22765){
var vec__22766 = p__22765;
var ns = cljs.core.nth.call(null,vec__22766,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__22766,(1),null);
return ((function (vec__22766,ns,vars__$1){
return (function (){
...
var G__22769 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__22769,G__22769__$1,env,once_fixtures,each_fixtures,vec__22766,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__22769,G__22769__$1,env,once_fixtures,each_fixtures,vec__22766,ns,vars__$1){
return (function (){
var seq__22770 = cljs.core.seq.call(null,vars__$1);
var chunk__22771 = null;
var count__22772 = (0);
var i__22773 = (0);
while(true){
if((i__22773 < count__22772)){
var v = cljs.core._nth.call(null,chunk__22771,i__22773);
var temp__5457__auto___22775 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___22775)){
var t_22776 = temp__5457__auto___22775;
each_fixture_fn.call(null,((function (seq__22770,chunk__22771,count__22772,i__22773,t_22776,temp__5457__auto___22775,v,each_fixture_fn,G__22769,G__22769__$1,env,once_fixtures,each_fixtures,vec__22766,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_22776)));
});})(seq__22770,chunk__22771,count__22772,i__22773,t_22776,temp__5457__auto___22775,v,each_fixture_fn,G__22769,G__22769__$1,env,once_fixtures,each_fixtures,vec__22766,ns,vars__$1))
);
} else {
}


var G__22777 = seq__22770;
var G__22778 = chunk__22771;
var G__22779 = count__22772;
var G__22780 = (i__22773 + (1));
seq__22770 = G__22777;
chunk__22771 = G__22778;
count__22772 = G__22779;
i__22773 = G__22780;
continue;
} else {
var temp__5457__auto__ = cljs.core.seq.call(null,seq__22770);
if(temp__5457__auto__){
var seq__22770__$1 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__22770__$1)){
var c__4319__auto__ = cljs.core.chunk_first.call(null,seq__22770__$1);
var G__22781 = cljs.core.chunk_rest.call(null,seq__22770__$1);
var G__22782 = c__4319__auto__;
var G__22783 = cljs.core.count.call(null,c__4319__auto__);
var G__22784 = (0);
seq__22770 = G__22781;
chunk__22771 = G__22782;
count__22772 = G__22783;
i__22773 = G__22784;
continue;
} else {
var v = cljs.core.first.call(null,seq__22770__$1);
var temp__5457__auto___22785__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___22785__$1)){
var t_22786 = temp__5457__auto___22785__$1;
each_fixture_fn.call(null,((function (seq__22770,chunk__22771,count__22772,i__22773,t_22786,temp__5457__auto___22785__$1,v,seq__22770__$1,temp__5457__auto__,each_fixture_fn,G__22769,G__22769__$1,env,once_fixtures,each_fixtures,vec__22766,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_22786)));
});})(seq__22770,chunk__22771,count__22772,i__22773,t_22786,temp__5457__auto___22785__$1,v,seq__22770__$1,temp__5457__auto__,each_fixture_fn,G__22769,G__22769__$1,env,once_fixtures,each_fixtures,vec__22766,ns,vars__$1))
);
} else {
}
...
});})(each_fixture_fn,G__22769,G__22769__$1,env,once_fixtures,each_fixtures,vec__22766,ns,vars__$1))
);
});})(each_fixture_fn,G__22769,G__22769__$1,env,once_fixtures,each_fixtures,vec__22766,ns,vars__$1))
], null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__22769__$1)].join('')));

}
})());
});
;})(vec__22766,ns,vars__$1))
...
//# sourceMappingURL=test.js.map?rel=1526705501905
