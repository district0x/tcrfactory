...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var pred__23280 = cljs.core.instance_QMARK_;
var expr__23281 = reactive_val;
if(cljs.core.truth_(pred__23280.call(null,reagent.ratom.RAtom,expr__23281))){
return "ra";
} else {
if(cljs.core.truth_(pred__23280.call(null,reagent.ratom.RCursor,expr__23281))){
return "rc";
} else {
if(cljs.core.truth_(pred__23280.call(null,reagent.ratom.Reaction,expr__23281))){
return "rx";
} else {
if(cljs.core.truth_(pred__23280.call(null,reagent.ratom.Track,expr__23281))){
return "tr";
} else {
return "other";
}
...
//# sourceMappingURL=interop.js.map?rel=1526705059353
